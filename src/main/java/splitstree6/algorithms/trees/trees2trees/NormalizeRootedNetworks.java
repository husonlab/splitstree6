/*
 *  NormalizeRootedNetworks.java Copyright (C) 2024 Daniel H. Huson
 *
 ...
 * Daniel Huson, 3.2020
 */
public class NormalizeRootedNetworks extends Trees2Trees {
	...
	public void compute(ProgressListener progress, TaxaBlock taxaBlock, TreesBlock inputData, TreesBlock outputData) throws IOException {
		...
		for (var inputTree : inputData.getTrees()) {
			...
			apply(inputTree, null, outputTree, null);
