/*
 *  PhyloFusionOld.java Copyright (C) 2024 Daniel H. Huson
 *
...
public class PhyloFusionOld extends Trees2Trees implements IExperimental {
	...
	public void compute(ProgressListener progress, TaxaBlock taxaBlock, TreesBlock treesBlock, TreesBlock outputBlock) throws IOException {
		progress.setTasks("PhyloFusionOld", "init");
