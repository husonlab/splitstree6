...
import static splitstree6.viewers.multitreesviewer.tree_try.EdgeLengthsCalculation.EdgeLengths.Uniform;
import static splitstree6.viewers.multitreesviewer.tree_try.EdgeLengthsCalculation.EdgeLengths.Weights;
...
public class TreeUnrootedLayout {
	...
	public static Group compute(TreePane.Diagram diagram, TaxaBlock taxaBlock, PhyloTree tree, boolean toScale, Font font) {
		...
		if (tree.getNumberOfNodes() > 0) {
			...
			final EdgeFloatArray edgeLengths = EdgeLengthsCalculation.computeEdgeLengths(tree, toScale ? Weights : Uniform);
