...
public class MatrixUtils {
	 ...
	 *
	 * @param D distance matrix (square, symmetric, zeros on diagonal)
	 * @return true iff triangle inequalities hold
	 */
	public static boolean verifyTriangleInequalities(double[][] D, double epsilon) {
