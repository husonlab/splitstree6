/*
 *  SplitNetworkEdits.java Copyright (C) 2024 Daniel H. Huson
 *
...
/**
 * maintains string array recording split-network edits
 * Daniel Huson, 2.2022
 */
public class SplitNetworkEdits {
	 ...
	 * @param splitShapeMap
	 */
	public static void applyEdits(String[] editsString, ObservableMap<Node, LabeledNodeShape> nodeShapeMap, ObservableMap<Integer, ArrayList<Shape>> splitShapeMap) {
