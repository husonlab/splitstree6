/*
 *  MaltsAlgorithm.java Copyright (C) 2024 Daniel H. Huson
 *
...
package splitstree6.algorithms.trees.trees2trees.malts;
...
public class MaltsAlgorithm {
	 ...
	 */
	public static List<PhyloTree> apply(Collection<PhyloTree> inputTrees, ProgressListener progress, int maxNumberNetworks) throws IOException {
		var taxa = new BitSet();
