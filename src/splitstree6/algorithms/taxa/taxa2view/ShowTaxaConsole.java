/*
 * ShowTaxaConsole.java Copyright (C) 2022 Daniel H. Huson
 *
...
public class ShowTaxaConsole extends Algorithm<DataBlock, ViewBlock> implements IgnoredInMethodsText {
	public ShowTaxaConsole() {
		super(DataBlock.class, ViewBlock.class);
	}
