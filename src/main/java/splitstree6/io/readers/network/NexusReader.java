...
public class NexusReader extends NetworkReader {
	...
	@Override
	public void read(ProgressListener progress, String fileName, TaxaBlock taxaBlock, NetworkBlock dataBlock) throws IOException {
