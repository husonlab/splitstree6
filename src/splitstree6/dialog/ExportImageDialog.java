...
public class ExportImageDialog {
	public static void show(String file, Stage stage, Node imageNode) {
		...
		fileChooser.setTitle("Export SplitsTree6 Image");
		...
		fileChooser.getExtensionFilters().addAll(new FileChooser.ExtensionFilter("Image Files (%s)".formatted(StringUtils.toString(supported, ", ")), formats));
